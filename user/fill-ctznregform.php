...
$municipality=$_POST['padd'];
$wardno=$_POST['postaladd'];
...
$sql="insert into tblapplication(UserID,ApplicationID,DateofBirth,Gender,FullName,Province,NameofFather,municipality,Wardno,MotherName,Email)values(:uid,:appnumber,:dob,:gender,:fname,:province,:fathername,:municipality,:wardno,:mothername,:email)";
...
$query->bindParam(':wardno',$wardno,PDO::PARAM_STR);
...
echo "<script>window.location.href ='fill-ctznregform.php'</script>";
  }
  else
    {
                                                ...
                                                <div class="all-form-element-inner">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Municipality</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                         ...
                                                         <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Ward No.</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                    <textarea type="number" class="form-control" name="postaladd" value="" required="true"/></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                       <div class="form-group-inner">
