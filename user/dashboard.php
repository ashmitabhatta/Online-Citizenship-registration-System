...
<head>
    ...
    <title>Dashboard | Online Citizenship Management System</title>
...
{               ?> 
                                        <div class="main-income-phara">
                                           <h2>Welcome to Online Citizenship Registration <?php  echo $row->FirstName;?>  <?php  echo $row->LastName;?>!!!</h2>
                                        </div>
                                        <?php $cnt=$cnt+1;}} ?>
                                    </div>
                                </div>
